...
barplot(kirche$Austritte, kirche$Jahr, main = header, col.main = "white", col.lab = "white", yaxt = "n", ylab = "Austritte (per 1.000)", xlab = "Jahreszahlen", names = c("2017", "2018", "2019", "2020"))
...
```{r deepLRCode, code = readLines(system.file("extdata", "Komplexeres_R.Skript.R", package = "ourdata", mustWork = FALSE))}
```
